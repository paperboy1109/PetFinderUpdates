...
// MARK: - Moved to separate file Pet.swift
//struct Pet {
//  var name = ""
//  var type = ""
//}
...
class PetTableViewController: UITableViewController, UIPopoverPresentationControllerDelegate {
  ...
  func search() {
    ...
    //    searchViewControllermodalPresentationStyle = .Popover
    //    searchViewControllermodalTransitionStyle = .CoverVertical
    //    searchViewControllerpopoverPresentationController?.delegate = self
    //    presentViewController(searchViewController, animated: true, completion: nil)
  }
